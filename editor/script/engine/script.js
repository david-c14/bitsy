...
function printSpriteFunc(environment,parameters,onReturn) {
	...
	if (names.sprite[spriteId] != undefined) {
		spriteId = names.sprite[spriteId]; // id is actually a name
	}
...
function printTileFunc(environment,parameters,onReturn) {
	...
	if (names.tile[tileId] != undefined) {
		tileId = names.tile[tileId]; // id is actually a name
	}
...
function printItemFunc(environment,parameters,onReturn) {
	...
	if (names.item[itemId] != undefined) {
		itemId = names.item[itemId]; // id is actually a name
	}
...
var Environment = function() {
	...
	this.HasOperator = function(symbol) {
		return operatorMap[symbol] != undefined;
	};

	this.EvalOperator = function(symbol, left, right, onReturn) {
		operatorMap[symbol](this, left, right, onReturn);
	};
